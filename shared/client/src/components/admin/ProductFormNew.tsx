...
import AIFieldEnhancer from './AIFieldEnhancer';
        ...
        <CardContent className="space-y-4">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <AIFieldEnhancer
                fieldType="title"
                productTitle={watch('name') || 'Товар'}
                currentValue={watch('name') || ''}
                onApply={(value) => setValue('name', value)}
              />
            </div>
            <Input
              id="name"
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <AIFieldEnhancer
                ...
                productTitle={watch('name') || 'Товар'}
                currentValue={watch('long_description') || ''}
                onApply={(value) => setValue('long_description', value)}
              />
              <Button
                type="button"
                variant="outline"
...
Без тяжелых металлов и других загрязнителей"
      ...
      <AIProductEnhancer
        ...
        onApplyChanges={(enhanced) => {
          if (enhanced.title) setValue('name', enhanced.title);
          if (enhanced.description) setValue('description', enhanced.description);
          if (enhanced.short_description) (setValue as any)('title', enhanced.short_description);
        }}
      />
