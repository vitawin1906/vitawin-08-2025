...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post("/api/upload/image", upload.single('image'), fileUploadSecurity, adminAuthMiddleware, uploadController.uploadImage);
  ...
  app.get("/api/images/file/:filename", imageController.getImage);
  app.get("/api/images/:filename", imageController.getImage); // Новый роут для поддержки /api/images/имя_файла.png
  app.delete("/api/images/file/:filename", imageController.deleteImage);
  app.get("/api/images", imageController.getAllImages);
  app.post("/api/migrate-images", imageController.migrateImages);
  ...
  app.post("/api/admin/login", loginRateLimit, xssProtection, sqlInjectionProtection, adminLogin);
